...
export function Footer() {
  return (
    <footer className="border-t border-[var(--line)] bg-white/80 backdrop-blur-xl">
      <div className="mx-auto grid w-full max-w-[1400px] xl:max-w-[1600px] 2xl:max-w-[1900px] gap-8 px-6 py-10 xl:px-12 2xl:px-20 md:grid-cols-3">
        <div>
      ...
      <div className="border-t border-[var(--line)]">
        <div className="mx-auto w-full max-w-[1400px] xl:max-w-[1600px] 2xl:max-w-[1900px] px-6 py-4 xl:px-12 2xl:px-20 text-sm text-[var(--text-soft)]">
